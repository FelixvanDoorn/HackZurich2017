...
# cap = cv2.VideoCapture("../testimages/straight1.jpg")
...
img = cv2.imread('../testimages/straight0.jpg')
...
cv2.circle(img_filter,(max1pos, YOFFSET), 5, (0,0,0), -1)
cv2.circle(img_filter,(max2pos, YOFFSET), 5, (0,0,0), -1)
...
#cv2.imshow('intensity image',crop_img)
